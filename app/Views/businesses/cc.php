<div class="card mb-4">
    ...
    <div class="card-body">
        <form role="form" id="myForm" method="POST" data-url="<?= base_url('businesses/update/cc/'.enc($record['id'])) ?>" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <?php if(isset($record['cc_document']) && !empty($record['cc_document'])): ?>
            ...
            <div class="d-flex justify-content-between align-items-center mt-4 border-top pt-3">
                <button type="button" class="btn btn-outline-secondary" onclick="loadMe('<?=base_url('businesses/view/'.enc($record['id']).'?form=cc')?>')">
