        ...
        <div class="card mb-4">
            <div class="card-header">
                <h5 onclick="$('.tablink').removeClass('w3-border-blue'); $(this).addClass('w3-border-blue'); loadMe('businesses/view/<?=enc($record['id'])?>')" class="w3-half w3-border-blue tablink w3-bottombar w3-hover-light-grey w3-padding"><?= lang('app.business_details') ?></h5>
                <h5 class="w3-half tablink w3-bottombar w3-hover-light-grey w3-padding" onclick="$('.tablink').removeClass('w3-border-blue'); $(this).addClass('w3-border-blue'); loadMe('dashboard/agreement/list/<?=enc($record['id'])?>','#target')"><?= lang('app.agreement') ?></h5>
            </div>  
            <div class="card-body">
                <div class="row">
