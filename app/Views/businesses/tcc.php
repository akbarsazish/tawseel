<div class="card mb-4">
    ...
    <div class="card-body">
        <form role="form" id="myForm" data-url="<?= base_url('businesses/update/tcc/'.enc($record['id'])) ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="d-flex justify-content-between align-items-center mt-4 border-top pt-3">
                <button type="button" class="btn btn-outline-secondary" onclick="loadMe('<?=base_url('businesses/view/'.enc($record['id']).'?form=tcc')?>')">
