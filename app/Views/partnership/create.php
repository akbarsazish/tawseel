<div class="card mb-4">
    ...
    <div class="card-body">
     <form id="myForm" data-url="<?= base_url('partnership/save') ?>"  method="POST">
        <?= csrf_field() ?>

        <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    <label for="title_ar"><strong><?= lang('app.title_en') ?>:</strong></label>
                    <input type="text" name="title_ar" id="title_ar" class="form-control" 
                        value="<?= old('title_ar', $siteInfo->title_ar ?? '') ?>">
                </div>
                <div class="form-group">
                    <label for="title_en"> <strong><?= lang('app.title_ar') ?>:</strong> </label>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <label for="subtitle_ar"><strong><?= lang('app.subtitle_ar') ?>:</strong></label>
                    <input type="text" name="subtitle_ar" id="subtitle_ar" class="form-control" 
                        value="<?= old('subtitle_ar', $siteInfo->subtitle_ar ?? '') ?>">
                </div>
                <div class="form-group">
                    <label for="subtitle_en"><strong><?= lang('app.subtitle_en') ?>:</strong></label>
