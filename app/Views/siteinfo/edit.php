<div class="card mb-4">
    ...
    <div class="card-body">
    <form id="myForm" data-url="<?= base_url('siteinfo/update/'. enc($siteInfo['id'])) ?>"  method="POST">
         <?= csrf_field() ?>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="facebook">Facebook URL</label>
                        <input type="url" name="facebook" id="editFacebook" class="form-control" 
                                value="<?= old('facebook', $siteInfo['facebook'] ?? '') ?>">
                    </div>
                    
                    <div class="form-group">
                        <label for="instagram">Instagram URL</label>
                        <input type="url" name="instagram" id="editInstagram" class="form-control" 
                               value="<?= old('instagram', $siteInfo['instagram'] ?? '') ?>">
                    </div>
                    
                    <div class="form-group">
                        <label for="twitter">Twitter URL</label>
                        <input type="url" name="twitter" id="editTwitter" class="form-control" 
                                value="<?= old('twitter', $siteInfo['twitter'] ?? '') ?>">
                    </div>
                    
                    <div class="form-group">
                        <label for="youtube">YouTube URL</label>
                        <input type="url" name="youtube" id="editYoutube" class="form-control" 
                                value="<?= old('youtube', $siteInfo['youtube'] ?? '') ?>">
                    </div>
                    
                    <div class="form-group">
                        <label for="linkedin">LinkedIn URL</label>
                        <input type="url" name="linkedin" id="editLinkedin" class="form-control" 
