...
<?= csrf_field() ?> 
    ...
    <div class="panel-body w3-row-padding">
        ...
        <div class="form-group w3-half">
            ...
            <input name="cr_document" type="file" accept=".pdf" required="required" class="form-control" />
        </div>
    ...
    <div class="form-group w3-col">
        ...
        <input name="id_document" type="file" accept=".pdf" required="required" class="form-control" />
    </div>    
    <button class="btn btn-primary nextBtn pull-right" type="button"><?= lang('app.next') ?></button>
</div>
</div>
...
<div class="panel panel-primary setup-content" id="step-3" style="display:none;">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <input name="cc_expire_date" maxlength="200" type="date" required="required" class="form-control" placeholder="<?= lang('app.cc_expire_date_title') ?>" value="<?= old('cc_expire_date') ?>" />
        </div>
        <div class="form-group">
            <label class="control-label"><?= lang('app.cc') ?></label>
            <input name="cc_document" type="file" accept=".pdf" required="required" class="form-control" />
        </div>
...
<div class="panel panel-primary setup-content" id="step-4" style="display:none;">
    ...
    <div class="panel-body w3-row-padding">
        ...
        <div class="form-group w3-half">
            ...
            <input name="ta_document" type="file" accept=".pdf" required="required" class="form-control" />
        </div>
        <button class="btn btn-primary nextBtn pull-right" type="button"><?= lang('app.next') ?></button>
    </div>
</div>
...
<div class="panel panel-primary setup-content" id="step-5" style="display:none;">
    ...
    <div class="panel-body w3-row-padding">
        ...
        <div class="form-group w3-col">
            ...
            <input name="lc_document" type="file" accept=".pdf" required="required" class="form-control" />
        </div>
        <button class="btn btn-primary nextBtn pull-right" type="button"><?= lang('app.next') ?></button>
    </div>
</div>
...
<div class="panel panel-primary setup-content" id="step-6" style="display:none;">
    ...
    <div class="panel-body w3-row-padding">
        ...
        <div class="form-group w3-col">
            ...
            <input name="tcc_tax_card_number" maxlength="200" type="text" required="required" class="form-control" placeholder="<?= lang('app.tax_card_number_title') ?>" value="<?= old('tcc_tax_card_number') ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 20);" />
        </div>
        <div class="form-group w3-col">
        ...
        <div class="form-group w3-col">
            <label class="control-label"><?= lang('app.ta') ?></label>
            <input name="tcc_document" type="file" accept=".pdf" required="required" class="form-control" />
        </div>
        <button class="btn btn-primary nextBtn pull-right" type="button"><?= lang('app.next') ?></button>
    </div>
</div>    
...
<div class="panel panel-primary setup-content" id="step-7" style="display:none;">
    ...
    <div class="panel-body w3-row-padding">
        ...
        <div class="form-group w3-col">
            ...
            <input name="vc_document" type="file" accept=".pdf" required="required" class="form-control" />
        </div>
