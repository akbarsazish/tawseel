<div class="card mb-4">
    <div class="card-header">
        <h2 class="h4 mb-0"><?= lang('app.edit') ?> <?= esc($record['fullname']) ?></h2>
    </div>
    <div class="card-body">
        <form id="myForm" data-url="<?= base_url('dashboard/users/update/'.enc($record['id'])) ?>">
            <?= csrf_field() ?>
           ...
           <div class="row mb-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" id="password" name="password" placeholder="<?= lang('app.password') ?>">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" id="cr" name="cr" placeholder="<?= lang('app.cr_title') ?>" value="<?= esc($record['cr']) ?>">
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <select name="logistics_type" id="logistics_type" class="form-control">
        ...
        <?php endif; ?>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <select id="province" name="province" class="form-control" onchange="$.post('<?= base_url('getcity/') ?>/', { name: $(this).val() }, function(data) { $('#city').html(data); });">
                ...
                <div class="col-md-4">
                    ...
                    <select id="city" name="city" class="form-control">
                        ...
                        if (!empty($province) && is_array($cities)) { ?>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" id="way" name="way" class="form-control" placeholder="Street name" value="<?= esc($record['way'] ?? '') ?>">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" id="address_line_1" name="address_line_1" class="form-control" placeholder="Street address, P.O. box" value="<?= esc($record['address_line_1'] ?? '') ?>">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <input type="text" id="location" name="location" class="form-control" placeholder="Type your address or click the locate button" value="<?= esc($record['location'] ?? '') ?>" aria-label="Location address">
            ...
            <div class="row mb-3">
                <div class="col-md-6 d-flex justify-content-start">
                    <button type="button" class="btn btn-outline-secondary" onclick="loadMe('<?= base_url('dashboard/users/profile/'.enc($record['id'])) ?>');">
...
<script>
    ...
    var selectedSids = <?= json_encode(explode(',', $record['role'])) ?>;
