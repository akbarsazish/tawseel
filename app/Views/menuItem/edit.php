...
<div class="card mb-4">
    <div class="card-header">
        <h3 class="h4 mb-0"><?= lang('app.edit_menu_item') ?></h3>
    </div>
    <div class="card-body">
        <form id="myForm" data-url="<?= base_url('update/item/' . enc($menu['id']) . '/' . enc($item['id'])) ?>">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        <label class="form-label">Title</label>
                        <input type="text" name="title_ar" class="form-control" required value="<?= $item['title_en'] ?? '' ?>">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
